...
# Librefm edits and little stuff by mrjovanovic <mjovanovic@gmail.com>
#
...
package GMB::Plugin::LIBREFMSCROBBLER;
use strict;
use warnings;
use constant
{	CLIENTID => 'gmb', VERSION => '0.1',
	OPT => 'PLUGIN_LIBREFMSCROBBLER_',#used to identify the plugin's options
	SAVEFILE => 'librefmscrobbler.queue', #file used to save unsent data
};
...
{	my $vbox=Gtk2::VBox->new(::FALSE, 2);
	...
	my $label2=Gtk2::Button->new(_"(see http://www.libre.fm)");
...
{	$HandshakeOK=0;
	...
	Send(\&response_cb,'http://turtle.libre.fm/?hs=true&p=1.2&c='.CLIENTID.'&v='.VERSION."&u=$user&t=$time&a=$auth");
}
